...
const routes = [
  ...
  },
  {
    exact: true,
    path: "/businesshome",
    component: lazy(() => import("./components/Business/BusinessHome/BusinessHome")),
  },
  {
    exact: true,
    path: "/customer-profile",
    component: lazy(() => import("./components/CustomerProfile/CustomerProfile")),
  },
  {
    exact: true,
    path: "/invoices",
    component: lazy(() => import("./components/Business/BusinessHome/Invoices")),
  },
  {
    exact: true,
    path: "/search",
  ...
  },
  {
    exact: true,
    path: "/supplier",
    component: lazy(() => import("./components/Supplier/Supplier")),
  },
];
